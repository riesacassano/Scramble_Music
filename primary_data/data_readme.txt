...
All raw data for E3 dataset A is combined in `E3_raw_data_combining.py`, resulting in `raw_combined_E3A.csv`. All raw data for E3 dataset B is in 'raw_combined_E3B.csv'. (This was obtained directly from Labvanced.) The data is prepared for analysis in `E3_raw_data_wrangling.Rmd` and are saved in `../E3/data/`.

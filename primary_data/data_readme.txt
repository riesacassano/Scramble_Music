...
For experiments 1, 2, and 4, and dataset 3A, each participant has its own .csv file in 'raw_data_anonymized/' from Labvanced. Files are labeled with the participants internal ID ('exp_subject_id' or 'Labvanced ID') which is consistent throughout. 
...
All raw data for E1, E2, and E4 is combined in `raw_data_combining.py`. The data is prepared for analysis in `raw_data_wrangling.R`.

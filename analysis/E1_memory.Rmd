...
```{r}
data <- read_csv('../data/E1-E2-E4/memory.csv', show_col_types = FALSE)
```
...
```{r}
contrasts(data$Musician) <- c(-1,1)#contr.sum(2)
...
print(summary(years_mus_scram, robust = TRUE), digits = 4)
```
